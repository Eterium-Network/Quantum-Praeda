package net.eteriumnetwork.quantum_praeda.core.init.datagen;

import net.eteriumnetwork.quantum_praeda.QuantumPraeda;
import net.eteriumnetwork.quantum_praeda.core.init.datagen.server.*;
import net.eteriumnetwork.quantum_praeda.core.init.datagen.client.QPBlockStateAndModelProvider;
import net.eteriumnetwork.quantum_praeda.core.init.datagen.client.QPItemModelProvider;
