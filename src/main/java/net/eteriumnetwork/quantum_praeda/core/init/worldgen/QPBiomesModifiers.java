...
public class QPBiomesModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_DEEPSLATE_NEUTRINIO_ORE_KEY =
        registerKey("add_"+RegistryBlock.DEEPSLATE_NEUTRINIO_ORE.getId().getPath());
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        QPLogger.info("Stating BiomesModifier Register: OVERWORLD QUANTUM ORES");
        context.register(
        ...
        QPLogger.info("Stating BiomesModifier Register: DEEPSLATE QUANTUM ORES");
        context.register(
            ADD_DEEPSLATE_NEUTRINIO_ORE_KEY,
            new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(QPPlacedFeature.DEEPSLATE_NEUTRINIO_ORE_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES
            )
        );
        context.register(
        ...
        QPLogger.info("Stating BiomesModifier Register: NETHER QUANTUM ORES");
        context.register(
        ...
        QPLogger.info("Stating BiomesModifier Register: END QUANTUM ORES");
        context.register(
