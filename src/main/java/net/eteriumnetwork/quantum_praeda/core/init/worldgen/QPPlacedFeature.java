...
public class QPPlacedFeature {
    ...
    public static final ResourceKey<PlacedFeature> DEEPSLATE_NEUTRINIO_ORE_PLACED_KEY =
        registerKey(RegistryBlock.DEEPSLATE_NEUTRINIO_ORE.getId().getPath()+"_placed");
    ...
    public static final ResourceKey<PlacedFeature> DEEPSLATE_ENTANGLION_ORE_PLACED_KEY =
        registerKey(RegistryBlock.DEEPSLATE_ENTANGLION_ORE.getId().getPath()+"_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        QPLogger.info("Stating PlacedFeature Register: OVERWORLD QUANTUM ORES");
        register(
                context,
        ...
        QPLogger.info("Stating PlacedFeature Register: DEEPSLATE QUANTUM ORES");
        register(
            context,
        ...
        register(
            context,
            DEEPSLATE_ENTANGLION_ORE_PLACED_KEY,
            configuredFeatureHolder.getOrThrow(QPConfiguredFeature.DEEPSLATE_ENTANGLION_ORE_KEY),
            QPOrePlacement.commonOrePlacement(
                8,
                HeightRangePlacement.uniform(
                    VerticalAnchor.absolute(-64),
        ...
        register(
            context,
            DEEPSLATE_NEUTRINIO_ORE_PLACED_KEY,
            configuredFeatureHolder.getOrThrow(QPConfiguredFeature.DEEPSLATE_NEUTRINIO_ORE_KEY),
            QPOrePlacement.rareOrePlacement(
                4,
                HeightRangePlacement.uniform(
                    VerticalAnchor.absolute(-64),
        ...
        QPLogger.info("Stating PlacedFeature Register: NETHER QUANTUM ORES");
        register(
                context,
        ...
        QPLogger.info("Stating PlacedFeature Register: END QUANTUM ORES");
        register(
                context,
