    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlockWithItem(
                ...
                models().cube(
                    ...
                    modLoc("block/" +RegistryBlock.END_GRAVITONITA_ORE.getId().getPath() +"_down"),
                    modLoc("block/" + RegistryBlock.END_GRAVITONITA_ORE.getId().getPath() + "_up"),
        ...
        simpleBlockWithItem(
                ...
                models().cube(
                    ...
                    modLoc("block/"+RegistryBlock.NETHER_SUPERCONDUTITA_ORE.getId().getPath()),
                    modLoc("block/"+RegistryBlock.NETHER_SUPERCONDUTITA_ORE.getId().getPath()+"_sides"),
                    modLoc("block/"+RegistryBlock.NETHER_SUPERCONDUTITA_ORE.getId().getPath()+"_sides"),
                    modLoc("block/"+RegistryBlock.NETHER_SUPERCONDUTITA_ORE.getId().getPath()+"_sides"),
                    modLoc("block/"+RegistryBlock.NETHER_SUPERCONDUTITA_ORE.getId().getPath()+"_sides")
                )
        ...
        simpleBlockWithItem(
            ...
            models().cube(
                ...
                modLoc("block/" + RegistryBlock.GRAVITONITA_COMPRESSOR.getId().getPath() + "_down"),
                modLoc("block/"+ RegistryBlock.GRAVITONITA_COMPRESSOR.getId().getPath()+ "_up"),
                modLoc("block/"+ RegistryBlock.GRAVITONITA_COMPRESSOR.getId().getPath()+ "_north"),
                modLoc("block/"+ RegistryBlock.GRAVITONITA_COMPRESSOR.getId().getPath()+ "_south"),
                modLoc("block/"+ RegistryBlock.GRAVITONITA_COMPRESSOR.getId().getPath()+ "_east"),
                modLoc("block/"+ RegistryBlock.GRAVITONITA_COMPRESSOR.getId().getPath()+ "_west")
            )
        );
        simpleBlockWithItem(
