...
public class QPPlacedFeature {
    ...
    public static final ResourceKey<PlacedFeature> OVERWORLD_NEUTRINIO_ORE_PLACED_KEY =
            registerKey(RegistryBlock.NEUTRINIO_ORE.getId().getPath()+"_placed");
    public static final ResourceKey<PlacedFeature> NETHER_NEUTRINIO_ORE_PLACED_KEY =
            registerKey(RegistryBlock.NETHER_NEUTRINIO_ORE.getId().getPath()+"_placed");
    ...
    public static final ResourceKey<PlacedFeature> OVERWORLD_ENTANGLION_ORE_PLACED_KEY =
            registerKey(RegistryBlock.ENTANGLION_ORE.getId().getPath()+"_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(
                context,
                OVERWORLD_NEUTRINIO_ORE_PLACED_KEY,
                configuredFeatureHolder.getOrThrow(QPConfiguredFeature.OVERWORLD_NEUTRINIO_ORE_KEY),
        ...
        register(
                context,
                NETHER_NEUTRINIO_ORE_PLACED_KEY,
                configuredFeatureHolder.getOrThrow(QPConfiguredFeature.NETHER_NEUTRINIO_ORE_KEY),
                QPOrePlacement.rareOrePlacement(
                        2,
                        HeightRangePlacement.uniform(
                                VerticalAnchor.absolute(-64),
        ...
        register(
                context,
                OVERWORLD_ENTANGLION_ORE_PLACED_KEY,
                configuredFeatureHolder.getOrThrow(QPConfiguredFeature.OVERWORLD_ENTANGLION_ORE_KEY),
                QPOrePlacement.rareOrePlacement(
                        8,
                        HeightRangePlacement.uniform(
                                VerticalAnchor.absolute(-64),
        ...
        register(
                context,
                OVERWORLD_SPINORITA_ORE_PLACED_KEY,
                configuredFeatureHolder.getOrThrow(QPConfiguredFeature.OVERWORLD_SPINORITA_ORE_KEY),
                QPOrePlacement.rareOrePlacement(
                        8,
                        HeightRangePlacement.uniform(
                                VerticalAnchor.absolute(-64),
